...
export const complexes: Complex[] = [
  ...
  { name: "양산 명지써밋 주상복합", region: "광주광역시 북구", households: 273, area: 52476, kind: "mixed-use", aliases: ["양산명지써밋"], image: "/images/cases/featured/양산명지.png", isFeatured: true },
  ...
  { name: "창우빌딩", region: "광주광역시 광산구", households: 23, area: 4521.77, kind: "mixed-use" },
  ...
  { name: "첨단 미르채리버파크오피스텔", region: "광주광역시 광산구", households: 508, area: 29004.85, kind: "mixed-use", aliases: ["첨단미르채리버파크"], image: "/images/cases/featured/미르채리버파크.png", isFeatured: true },
  { name: "첨단 부영1차아파트", region: "광주광역시 광산구", households: 1198, area: 101801, kind: "apartment", aliases: ["첨단1차부영"], image: "/images/cases/featured/첨단부영1차.jpg", isFeatured: true },
  ...
  { name: "첨단프라자", region: "광주광역시 광산구", households: 81, kind: "apartment", aliases: ["첨단프라자"], image: "/images/cases/featured/첨단프라자.png", isFeatured: true },
  ...
  { name: "운남 삼성아파트", region: "광주광역시 광산구", households: 1956, area: 179899, kind: "apartment", aliases: ["운남 삼성"], image: "/images/cases/featured/운남삼성아파트.png", isFeatured: true },
...
export const pastComplexes: PastComplex[] = [
  ...
  { name: "그랜드센트럴 아파트", region: "광주광역시 동구", households: 2336, area: 364652, period: "2020.9.1 ~ 2021.5.31", kind: "apartment", aliases: ["광주 그랜드 센트럴"], image: "/images/cases/featured/그랜드센트럴아파트.jpg", isFeatured: true },
  ...
  { name: "문흥대주2차아파트", region: "광주광역시 북구", households: 959, area: 86137, period: "2023.09.05 ~ 2025.09.04", kind: "apartment", aliases: ["문흥대주2차"], image: "/images/cases/featured/문흥대주.png", isFeatured: true },
...
// 채용 공고 (Job openings)
//
// 관리자가 새 공고를 등록하려면 이 배열에 객체를 추가하면 됩니다(추후 admin
// 페이지로 확장 가능). isActive=false 로 두면 목록·미리보기에서 숨겨집니다.
//
// ⚠️ 자격 요건·우대 사항·직무 내용은 클라이언트가 구체 정보를 주지 않아
//    '관리소장 채용 일반 통념'에 맞춘 안전한 일반 카피로 작성. 잘못된 단정 금지.
// ─────────────────────────────────────────────────────────────────────────────

export type JobOpening = {
  /** URL·식별자로 쓰이는 고유 slug */
  id: string;
  /** 직무명 */
  title: string;
  /** 채용 형태 — 수시채용·상시채용·정규직 등 */
  type: string;
  /** 모집 지역 */
  location: string;
  /** 공고 한 줄 요약 (상세 페이지 도입부) */
  summary?: string;
  /** 주요 업무 — 일반 카피 */
  ...
  /** 지원 방법 */
  applyMethod: string;
  /** 지원 접수 이메일 (지원하기 CTA에 사용) */
  applyEmail?: string;
  /** 마감일 (YYYY-MM-DD) — null이면 상시채용 */
  deadline: string | null;
  /** 등록일 (YYYY-MM-DD) */
  postedAt: string;
  /** 활성 여부 — false면 목록에서 숨김 */
  isActive: boolean;
};

export const jobOpenings: JobOpening[] = [
  {
    id: "manager-gwangsan-2026",
    title: "관리소장",
    type: "수시채용",
    location: "광주광역시 광산구",
    summary:
      "(주)케이비개발이 관리하는 공동주택 단지의 관리소장을 수시 채용합니다. 입주민과 가장 가까운 자리에서 단지 운영 전반을 책임지고, 신뢰받는 주거 환경을 함께 만들어 갈 분을 찾습니다.",
    responsibilities: [
      "공동주택 시설·운영 전반 관리 및 입주자대표회의 업무 지원",
      "관리비 운영·예산 집행 등 단지 회계·행정 총괄",
      "경비·미화·시설 등 현장 인력 관리 및 입주민 민원 대응",
      "관련 법령 준수, 정기 안전점검 일정 관리 등 행정 업무",
    ],
    requirements: [
      "공동주택·시설관리 분야 경력자 (관리소장·관리과장·시설팀 등)",
      "원활한 의사소통 능력과 입주민 응대에 대한 책임감",
      "기본적인 문서 작성 및 회계·행정 처리 가능자",
    ],
    preferred: [
      "주택관리사(보) 등 관련 자격증 보유자",
      "공동주택 관리소장 또는 동종 업계 근무 경력자",
      "광주광역시 및 인근 지역 거주자",
    ],
