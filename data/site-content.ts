...
export type Counter = {
  ...
  context?: string;
  /** Phase 14-N — 화면 표기용 값 (실제 length 154와 마케팅 표기 155+ 분리). 지정 시 value 대신 노출. */
  displayValue?: number;
  /** Phase 14-N — 화면 표기용 suffix (예: "+") */
...
export const contact: Contact = {
  ...
  address: "전남광주특별시 광산구 월계로 223‑22, 2층 201·202호",
...
export const counters: Counter[] = [
  {
    ...
    /** Phase 14-N (2026-05-21) — 의왕초평 과거 이동 후 153개 단지 세대수 합산.
        Phase 14-M 정본 48,959 (154 단지) − 의왕초평 981 + 신규 1,491 = 49,469.
        신규: 더샵광주포레스트 +907(84→991) + 금남유탑유블레스 +480 + 창우 +23 + 첨단프라자 +81. */
    value: 49469,
    suffix: "+",
    context: "약 15만 명의 일상을 책임지는 규모",
  },
  {
    key: "complexes",
    label: "운영 단지",
...
export const businessAreas: BusinessArea[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "나무병원 등록(2급, 전남광주특별시) 기반 수목 진단·치료",
    ],
...
export const complexes: Complex[] = [
  { name: "계림아이파크 SK뷰", region: "전남광주특별시 동구", households: 1715, area: 175004, kind: "apartment", aliases: ["계림 아이파크 sk뷰"], image: "/images/ipark/계림아이파크 SK뷰.PNG", isFeatured: true },
  { name: "계림아이파크 SK뷰(근린생활)", region: "전남광주특별시 동구", households: 76, area: 5193, kind: "apartment", image: "/images/ipark/계림아이파크SK뷰(근린생활).PNG" },
  { name: "그랜드 센트럴 상가", region: "전남광주특별시 동구", households: 177, area: 14104, kind: "mixed-use", image: "/images/ipark/그랜드 센트럴 상가.PNG" },
  { name: "금남로 센텀시티", region: "전남광주특별시 동구", households: 224, area: 18792, kind: "mixed-use" },
  { name: "금남유탑유블레스", region: "전남광주특별시 동구", households: 480, kind: "apartment", aliases: ["금남유탑"] },
  { name: "동명동 센트럴파크오피스텔", region: "전남광주특별시 동구", households: 253, area: 21899.73, kind: "mixed-use" },
  { name: "무등산 명지로드힐", region: "전남광주특별시 동구", households: 270, area: 35131.82, kind: "apartment" },
  { name: "용산호반맨션", region: "전남광주특별시 동구", households: 190, area: 15702, kind: "apartment" },
  { name: "학1마을아파트", region: "전남광주특별시 동구", households: 297, area: 31472.5, kind: "apartment" },
  { name: "광천 프라임 아너팰리스아파트", region: "전남광주특별시 서구", households: 186, area: 21956.98, kind: "apartment" },
  { name: "농성 삼익아파트", region: "전남광주특별시 서구", households: 374, kind: "apartment" },
  { name: "대광로제비앙 본사", region: "전남광주특별시 서구", kind: "mixed-use" },
  { name: "동천호반베르디움", region: "전남광주특별시 서구", households: 803, area: 140807, kind: "apartment" },
  { name: "마륵시티", region: "전남광주특별시 서구", kind: "apartment" },
  { name: "쌍촌프라임아너팰리스", region: "전남광주특별시 서구", households: 52, area: 6136.1531, kind: "apartment" },
  { name: "화정유탑", region: "전남광주특별시 서구", households: 286, kind: "apartment" },
  { name: "화정한국아델리움 1단지", region: "전남광주특별시 서구", households: 28, area: 6341.855, kind: "apartment" },
  { name: "화정한국아델리움 2단지", region: "전남광주특별시 서구", households: 28, area: 6367.079, kind: "apartment" },
  { name: "휴먼빌딩", region: "전남광주특별시 서구", households: 107, area: 10817.38, kind: "mixed-use" },
  { name: "골드레이크(송화)", region: "전남광주특별시 남구", households: 530, kind: "apartment" },
  { name: "방림동 오네뜨하이브", region: "전남광주특별시 남구", households: 225, area: 21025.1177, kind: "apartment" },
  { name: "백운동 프라임로하스", region: "전남광주특별시 남구", households: 17, kind: "apartment" },
  { name: "봉선 유탑 메트로시티", region: "전남광주특별시 남구", households: 88, area: 14652, kind: "apartment" },
  { name: "봉선동 아델리움57 더힐", region: "전남광주특별시 남구", households: 29, area: 5836.8466, kind: "apartment" },
  { name: "봉선라인2,3차", region: "전남광주특별시 남구", households: 358, area: 35398, kind: "apartment" },
  { name: "봉선무등파크3차2단지", region: "전남광주특별시 남구", households: 309, area: 33291.38, kind: "apartment" },
  { name: "스타타워(케이오아시스)", region: "전남광주특별시 남구", kind: "mixed-use" },
  { name: "양림1휴먼시아", region: "전남광주특별시 남구", households: 987, area: 127525.6642, kind: "apartment", aliases: ["양림1휴먼시아"], image: "/images/cases/featured/양림휴먼시아.png", isFeatured: true },
  { name: "효천하우스디", region: "전남광주특별시 남구", households: 324, area: 16792, kind: "apartment", type: "LH", aliases: ["효천 천년나무 2단지"], image: "/images/cases/featured/효천하우스디.png" },
  { name: "각화 휴먼파크 서희스타힐스", region: "전남광주특별시 북구", households: 946, area: 107277, kind: "apartment", aliases: ["각화 휴먼파크 서희스타힐스"], image: "/images/cases/featured/휴먼파크서희.png", isFeatured: true },
  { name: "더샵 광주포레스트 아파트", region: "전남광주특별시 북구", households: 991, kind: "apartment", aliases: ["더샵광주포레스트", "더샵 광주포레스트 오피스텔"], image: "/images/cases/featured/더샵포레스트아파트.png", isFeatured: true },
  { name: "무등산 자이앤어울림 상가", region: "전남광주특별시 북구", households: 15, area: 1994, kind: "mixed-use" },
  { name: "문흥우성아파트", region: "전남광주특별시 북구", households: 564, kind: "apartment" },
  { name: "신안동 프라임로하스", region: "전남광주특별시 북구", households: 20, area: 29679, kind: "apartment" },
  { name: "양산 명지써밋 주상복합", region: "전남광주특별시 북구", households: 273, area: 52476, kind: "mixed-use", aliases: ["양산명지써밋"], image: "/images/cases/featured/양산명지.png", isFeatured: true },
  { name: "오치 대광아파트", region: "전남광주특별시 북구", households: 111, area: 5826, kind: "apartment" },
  { name: "오치 우성아파트", region: "전남광주특별시 북구", households: 402, area: 43721, kind: "apartment" },
  { name: "용봉 금호아파트", region: "전남광주특별시 북구", households: 221, area: 34185, kind: "apartment" },
  { name: "용봉 삼성아파트", region: "전남광주특별시 북구", households: 544, area: 65734, kind: "apartment" },
  { name: "용봉 한국아델리움2차아파트", region: "전남광주특별시 북구", households: 61, area: 5546.45, kind: "apartment" },
  { name: "용봉엘리체", region: "전남광주특별시 북구", households: 430, area: 43735.327, kind: "apartment" },
  { name: "운암 블루시안1차", region: "전남광주특별시 북구", households: 103, area: 12186, kind: "apartment" },
  { name: "운암 센텀플로라에듀", region: "전남광주특별시 북구", households: 60, area: 7539, kind: "apartment" },
  { name: "임동평화맨션", region: "전남광주특별시 북구", households: 196, area: 20051, kind: "apartment" },
  { name: "점핑몬스터", region: "전남광주특별시 북구", kind: "apartment" },
  { name: "중흥 프라임베르가 아파트", region: "전남광주특별시 북구", households: 114, area: 13310.93, kind: "apartment" },
  { name: "무진 테라스", region: "전남광주특별시 광산구", households: 24, area: 6493, kind: "apartment" },
  { name: "미르채 프라자 상가", region: "전남광주특별시 광산구", households: 31, area: 3738, kind: "mixed-use" },
  { name: "벨루미체 첨단", region: "전남광주특별시 광산구", households: 103, area: 11047.405, kind: "apartment" },
  { name: "선운 메디컬스퀘어", region: "전남광주특별시 광산구", households: 37, area: 4781, kind: "mixed-use" },
  { name: "송정역 숲안애1차아파트", region: "전남광주특별시 광산구", households: 82, area: 10146.51, kind: "apartment" },
  { name: "수완 대라수 상가", region: "전남광주특별시 광산구", households: 33, area: 1932, kind: "mixed-use" },
  { name: "어등산 대광로제비앙", region: "전남광주특별시 광산구", households: 213, area: 21958, kind: "apartment" },
  { name: "우산동 am-city 스카이하이", region: "전남광주특별시 광산구", households: 154, area: 6025.0571, kind: "mixed-use" },
  { name: "우산동 am-city 하이클래스", region: "전남광주특별시 광산구", households: 150, area: 6067.2496, kind: "mixed-use" },
  { name: "우산동 더스위트2차 센트럴빌", region: "전남광주특별시 광산구", households: 26, area: 2569, kind: "apartment" },
  { name: "창우빌딩", region: "전남광주특별시 광산구", households: 23, area: 4521.77, kind: "mixed-use" },
  { name: "첨단 AM-STAY 센트럴파크 오피스텔", region: "전남광주특별시 광산구", households: 98, area: 4039, kind: "mixed-use" },
  { name: "첨단 대라수1차", region: "전남광주특별시 광산구", households: 315, area: 41800.73, kind: "apartment" },
  { name: "첨단 도휘에드가2차", region: "전남광주특별시 광산구", households: 288, area: 13086.9, kind: "apartment" },
  { name: "첨단 무들에코클래스", region: "전남광주특별시 광산구", households: 355, area: 14262.59, kind: "apartment" },
  { name: "첨단 미르채리버파크오피스텔", region: "전남광주특별시 광산구", households: 508, area: 29004.85, kind: "mixed-use", aliases: ["첨단미르채리버파크"], image: "/images/cases/featured/미르채리버파크.png", isFeatured: true },
  { name: "첨단 부영1차아파트", region: "전남광주특별시 광산구", households: 1198, area: 101801, kind: "apartment", aliases: ["첨단1차부영"], image: "/images/cases/featured/첨단부영1차.jpg", isFeatured: true },
  { name: "첨단 야스텍타워", region: "전남광주특별시 광산구", households: 54, area: 8986, kind: "mixed-use" },
  { name: "첨단 윤진리안채리버뷰", region: "전남광주특별시 광산구", households: 182, area: 10099.09, kind: "apartment" },
  { name: "첨단 윤진리안채상가(본사)", region: "전남광주특별시 광산구", households: 14, area: 3228.42, kind: "mixed-use" },
  { name: "첨단 일신프레뷰아파트", region: "전남광주특별시 광산구", households: 113, area: 14824.3, kind: "apartment" },
  { name: "첨단 중해마루힐", region: "전남광주특별시 광산구", households: 350, area: 10305, kind: "apartment" },
  { name: "첨단 한양에드가3차 301동", region: "전남광주특별시 광산구", households: 71, area: 3030.17, kind: "apartment" },
  { name: "첨단 한양에드가3차 302동", region: "전남광주특별시 광산구", households: 195, area: 7438.37, kind: "apartment" },
  { name: "첨단 한양에드가3차 303동", region: "전남광주특별시 광산구", households: 195, area: 7438.37, kind: "apartment" },
  { name: "첨단 힐스테이트 리버파크 상가", region: "전남광주특별시 광산구", households: 36, area: 2790.87, kind: "mixed-use" },
  { name: "첨단프라자", region: "전남광주특별시 광산구", households: 81, kind: "apartment", aliases: ["첨단프라자"], image: "/images/cases/featured/첨단프라자.png", isFeatured: true },
  { name: "도산 서경아파트", region: "전남광주특별시 광산구", households: 306, area: 24041.67, kind: "apartment" },
  { name: "도산 우미아파트", region: "전남광주특별시 광산구", households: 348, area: 27610, kind: "apartment" },
  { name: "도천1단지 중흥파크맨션", region: "전남광주특별시 광산구", households: 408, area: 34413.65, kind: "apartment" },
  { name: "소촌2차 국제미소래 아파트", region: "전남광주특별시 광산구", households: 382, area: 59786, kind: "apartment" },
  { name: "수완 현진에버빌 1단지아파트", region: "전남광주특별시 광산구", households: 672, area: 147884.61, kind: "apartment" },
  { name: "수완2차 중흥S-클래스아파트", region: "전남광주특별시 광산구", households: 241, area: 28915, kind: "apartment" },
  { name: "수완대라수 어썸테라스", region: "전남광주특별시 광산구", households: 140, area: 29738, kind: "apartment" },
  { name: "수완대성베르힐", region: "전남광주특별시 광산구", households: 410, area: 45013, kind: "apartment" },
  { name: "신창 부영6차아파트", region: "전남광주특별시 광산구", households: 494, area: 57057, kind: "apartment" },
  { name: "운남 삼성아파트", region: "전남광주특별시 광산구", households: 1956, area: 179899, kind: "apartment", aliases: ["운남 삼성"], image: "/images/cases/featured/운남삼성아파트.png", isFeatured: true },
  { name: "첨단 부영 3차", region: "전남광주특별시 광산구", households: 492, area: 50420, kind: "apartment" },
  ...
  { name: "오송역 대광로제비앙", region: "충청북도 청주시", households: 1615, area: 178211.1935, kind: "apartment", aliases: ["오송역대광로제비앙"], image: "/images/cases/featured/오송역대광.jpg", isFeatured: true },
  ...
  { name: "양주 회천 A21BL", region: "경기도 양주시", households: 995, area: 151434, kind: "apartment", aliases: ["양주회천베네스트"], image: "/images/cases/featured/양주회천.png", isFeatured: true },
  ...
  { name: "용해호반리젠시빌", region: "전라남도 목포시", households: 732, area: 84950, kind: "apartment", aliases: ["목포용해호반리젠시빌"], image: "/images/cases/featured/용해호반.png", isFeatured: true },
...
export const pastComplexes: PastComplex[] = [
  { name: "에드가리움", region: "전남광주특별시 광산구", households: 103, area: 8546, period: "2019.3.1 ~ 2025.10.31", kind: "apartment" },
  { name: "수완산이고운더테라스", region: "전남광주특별시 광산구", households: 76, area: 8968, period: "2018.10.1 ~ 2021.9.30", kind: "apartment" },
  { name: "광주 송정역 모아엘가", region: "전남광주특별시 광산구", households: 341, area: 22905, period: "2019.6.1 ~ 2025.6.31", kind: "apartment" },
  { name: "리안채", region: "전라북도 고창군", households: 160, area: 18257, period: "2018.8.1 ~ 2021.1.31", kind: "apartment" },
  { name: "동우아스트로", region: "전남광주특별시 북구", households: 158, area: 16306, period: "2019.12 ~ 2020.12.31", kind: "apartment" },
  { name: "목포 상동 프라임 주상복합아파트", region: "전라남도 목포시", households: 171, area: 21463, period: "2020.6.1 ~ 2026.5.31", kind: "mixed-use" },
  { name: "그랜드센트럴 아파트", region: "전남광주특별시 동구", households: 2336, area: 364652, period: "2020.9.1 ~ 2021.5.31", kind: "apartment", aliases: ["광주 그랜드 센트럴"], image: "/images/cases/featured/그랜드센트럴아파트.jpg", isFeatured: true },
  { name: "어등산 한양수자인 아파트", region: "전남광주특별시 광산구", households: 592, area: 76999, period: "2021.10.1 ~ 2024.9.30", kind: "apartment" },
  { name: "의정부 LH고산3단지 아파트", region: "경기도 의정부시", households: 1331, area: 155225, period: "2021.05.13 ~ 2021.12.31", kind: "apartment", type: "LH", aliases: ["의정부 LH고산3단지"], image: "/images/cases/featured/고산3단지.jpg", isFeatured: true },
  { name: "첨단 부영e그린", region: "전남광주특별시 광산구", households: 384, area: 44725, period: "2020.1.1 ~ 2025.12.31", kind: "apartment" },
  { name: "봉선라인광장1차아파트", region: "전남광주특별시 남구", households: 385, area: 33000, period: "2023.1.1 ~ 2025.12.31", kind: "apartment" },
  { name: "여수 양우내안애 아파트", region: "전라남도 여수시", households: 813, area: 113641, period: "2021.9.1 ~ 2024.8.31", kind: "apartment" },
  { name: "더샾광주포레스트 아파트", region: "전남광주특별시 북구", households: 907, area: 149929, period: "2023.7.31 ~ 2024.8.31", kind: "apartment" },
  { name: "첨단 프라임시티 서희스타힐스", region: "전남광주특별시 북구", households: 414, area: 42836, period: "2024.7.26 ~ 2025.3.31", kind: "apartment" },
  ...
  { name: "문흥대주2차아파트", region: "전남광주특별시 북구", households: 959, area: 86137, period: "2023.09.05 ~ 2025.09.04", kind: "apartment", aliases: ["문흥대주2차"], image: "/images/cases/featured/문흥대주.png", isFeatured: true },
  { name: "의왕초평 A-3BL 신혼희망타운", region: "경기도 의왕시 초평동", households: 981, area: 125868.32, period: "2023.10.16 ~ 2026.06.30", client: "한국토지주택공사 경기남부지역본부", kind: "apartment", type: "LH", image: "/images/cases/featured/의왕초평.png", isFeatured: true },
];
...
export const partners: Partner[] = [
  ...
  { name: "전남광주특별시청", category: "public" },
  { name: "전남광주특별시 광산구청", category: "public" },
