...
const TITLE = "법적 자격과 기술 자산";
const ITALIC = "기술 자산";
const SUBTITLE = "보유한 인허가와 인증서로 증명하는 신뢰입니다.";
...
export function LicensesHero() {
  ...
  return (
    <section
      aria-labelledby="licenses-hero-title"
      ...
      <Container>
        <nav aria-label="Breadcrumb" className="mb-12">
          <ol className="flex items-center gap-3 text-xs font-medium uppercase tracking-[0.2em] text-ink-muted">
            ...
            <li className="text-ink-soft">LICENSES</li>
          </ol>
        </nav>
